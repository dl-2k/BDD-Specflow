...
namespace final.Page
{
    public class DeleteBookPage
    {
        ...
        //public void AssertBookDeleted(string bookTitle)
        //{
        //    bool isBookDeleted = false;
        //    WebDriverWait wait = new WebDriverWait(DriverManager.driver, TimeSpan.FromSeconds(5));

        //    try
        //    {
        //        wait.Until(ExpectedConditions.InvisibilityOfElementLocated(By.XPath($"//a[text()='{bookTitle}']")));
        //        isBookDeleted = true;
        //    }
        ...
        //    if (!isBookDeleted)
        //    {
        //        throw new Exception($"The book titled '{bookTitle}' was not deleted successfully.");
        //    }
        //}
